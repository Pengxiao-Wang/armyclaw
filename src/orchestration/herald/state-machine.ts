...
const VALID_TRANSITIONS: Record<TaskState, TaskState[]> = {
  RECEIVED: ['PLANNING', 'EXECUTING', 'DONE', 'FAILED'],
  PLANNING: ['GATE1_REVIEW', 'FAILED'],
  GATE1_REVIEW: ['DISPATCHING', 'DELIVERING', 'PLANNING', 'FAILED'],
  DISPATCHING: ['EXECUTING', 'FAILED'],
  EXECUTING: ['COLLECTING', 'DONE', 'FAILED'],
  COLLECTING: ['GATE2_REVIEW', 'FAILED'],
  GATE2_REVIEW: ['DELIVERING', 'DISPATCHING', 'PLANNING', 'FAILED'],
  DELIVERING: ['DONE', 'FAILED'],
  DONE: [],
  FAILED: ['RECEIVED'],
  CANCELLED: [],
  PAUSED: ['RECEIVED', 'PLANNING', 'GATE1_REVIEW', 'DISPATCHING', 'EXECUTING', 'COLLECTING', 'GATE2_REVIEW', 'DELIVERING'],
};
