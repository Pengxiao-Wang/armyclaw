...
export const ChiefOfStaffOutputSchema = z.object({
  ...
  plan: z.object({
    ...
    steps: z.array(z.object({
      id: z.string(),
      description: z.string(),
      estimated_duration_sec: z.number(), // required per step
      complexity: z.enum(['simple', 'moderate', 'complex']),
      depends_on: z.array(z.string()).optional(),
    })),
    estimated_tokens: z.number(),
    estimated_duration_sec: z.number(), // required
    complexity: z.enum(['simple', 'moderate', 'complex']),
  }).optional(),
  campaign: z.object({
    name: z.string(),
...
export const CollectingOutputSchema = z.object({
  integrated_report: z.string(),
  summary: z.string(),
